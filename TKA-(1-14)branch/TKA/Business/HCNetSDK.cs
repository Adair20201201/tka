...
namespace TKA
{
    public sealed class HCNetSDK_X86
    {
        #region 宏定义
        /// <summary>
        /// DVR本地登陆名
        ...
        **************************************************/
        ...
        [DllImport("X86dll/HCNetSDK.dll", EntryPoint = "NET_DVR_Login", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
        ...
        public struct NET_DVR_DEVICEINFO_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.SERIALNO_LEN)]
        ...
        /// <summary>
        /// void(CALLBACK *fRealDataCallBack_V30) (int lRealHandle, uint dwDataType, BYTE *pBuffer, uint dwBufSize, IntPtr pUser)
        /// </summary>
        ...
        /// <param name="pUser">输入的用户数据</param>
        public delegate void RealDataCallBack_V30(int lRealHandle, uint dwDataType, ref byte pBuffer, uint dwBufSize, IntPtr pUser);
        /// <summary>
        ...
        public delegate void RealDataCallBack(int lRealHandle, uint dwDataType, ref byte pBuffer, uint dwBufSize, IntPtr dwUser);
        //int lRealHandle, uint dwDataType, ref byte pBuffer, uint dwBufSize, IntPtr pUser
        /// <summary>
        /// 6.1.1   实时码流数据捕获
        ...
        public struct NET_DVR_ALARMER
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MACADDR_LEN)]
        ...
        public struct NET_DVR_ALARMINFO_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_ALARMOUT_V30)]
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_CHANNUM_V30)]
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_DISKNUM_V30)]
        ...
        public struct NET_DVR_ALARMINFO
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_ALARMOUT)]
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_CHANNUM)]
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_DISKNUM)]
        ...
        public struct NET_DVR_IPALARMINFO
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_ANALOG_CHANNUM)]
        ...
        public struct NET_DVR_WORKSTATE_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_ALARMIN_V30)]
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_ALARMIN)]
        ...
        public struct NET_DVR_LOG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_NAMELEN)]
        ...
        public struct NET_DVR_DECCHANINFO
        {
            ...
            /// 	public byte sUserName[NAME_LEN];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.NAME_LEN)]
            public byte[] sUserName;
            /// <summary>
            /// 密码
            /// 	public byte sPassword[PASSWD_LEN];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.PASSWD_LEN)]
        ...
        public struct NET_DVR_NETCFG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_DOMAIN_NAME)]
        ...
        public struct NET_DVR_DECODERCFG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_PRESET_V30)]
            public byte[] bySetPreset;
            /// <summary>
            /// 巡航是否设置: 0-没有设置,1-设置
            ///     public byte bySetCruise[MAX_CRUISE_V30];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_CRUISE_V30)]
            public byte[] bySetCruise;
            /// <summary>
            /// 轨迹是否设置,0-没有设置,1-设置
            ///     public byte bySetTrack[MAX_TRACK_V30];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_TRACK_V30)]
        ...
        public struct NET_DVR_DECODERCFG
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_PRESET)]
            public byte[] bySetPreset;
            /// <summary>
            /// 巡航是否设置: 0-没有设置,1-设置
            ///     public byte bySetCruise[MAX_CRUISE];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_CRUISE)]
            public byte[] bySetCruise;
            /// <summary>
            /// 轨迹是否设置,0-没有设置,1-设置
            ///     public byte bySetTrack[MAX_TRACK];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_TRACK)]
            public byte[] bySetTrack;
        }
        #endregion
        #region 232串口参数配置
        ...
        public struct NET_DVR_PREVIEWCFG
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_WINDOW)]
            public byte[] bySwitchSeq;
        }
        #endregion
        #region 视频输出参数配置
        ...
        public struct NET_DVR_USER_INFO_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_RIGHT)]
        ...
        public struct NET_DVR_AUXOUTCFG_V30
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_AUXOUT_V30)]
        ...
        public struct NET_DVR_AUXOUTCFG
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.MAX_AUXOUT)]
            public uint[] dwAuxSwitchTime;
            /// <summary>
            /// 辅助输出预览顺序, 0xff表示相应的窗口不预览
        ...
        public struct NET_DVR_SINGLE_NFS
        {
            ...
            ///     public byte sNfsDirectory[PATHNAME_LEN];
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.PATHNAME_LEN)]
            public byte[] sNfsDirectory;
        }
        /// <summary>
        /// 网络文件系统参数
        ...
        public struct NET_DVR_CRUISE_PARA
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.CRUISE_MAX_PRESET_NUMS)]
            public byte[] byPresetNo;
            /// <summary>
            /// 巡航速度
        ...
        public struct NET_DVR_PTZ_PROTOCOL
        {
            ...
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = HCNetSDK_X86.DESC_LEN)]
    ...
    public sealed class HCNetSDK_X64
    {
        #region 宏定义
        /// <summary>
        /// DVR本地登陆名
        ...
        **************************************************/
        ...
        /// <param name="lpDeviceInfo">[out]指向NET_DVR_DEVICEINFO结构</param>
        /// <returns>-1表示失败，其他值表示返回的用户ID值，该ID值是由SDK分配，每个用户ID值在客户端是唯一的</returns>
        [DllImport("X64dll/HCNetSDK.dll", EntryPoint = " NET_DVR_Login", CharSet = CharSet.Auto, CallingConvention = CallingConvention.StdCall)]
        public static extern int NET_DVR_Login(string sDVRIP, ushort wDVRPort, string sUserName, string sPassword, out NET_DVR_DEVICEINFO lpDeviceInfo);
        #endregion
        #region 2.1.2       注销用户
        /// <summary>
        ...
        /// <param name="dwBufSize">缓冲区的大小</param>
        /// <param name="pUser">输入的用户数据</param>
        public delegate void RealDataCallBack_V40(int lRealHandle, uint dwDataType, ref byte pBuffer, uint dwBufSize, IntPtr pUser);
        /// <summary>
        /// 5.1.2   启动客户端实时预览[可选connect是否在线程中处理]
        ///     说明
        ///         不阻塞：设备应答请求连接就认为连接成功，如果发生码流接收失败、播放失败等情况以预览异常的方式告知应用层。在循环播放的时候可以减短停顿的时间。与原来的NET_DVR_RealPlay功能一致。
        ...
        /// <returns>-1表示失败，其他值作为NET_DVR_StopRealPlay等函数的参数</returns>
        [DllImport("X64dll/HCNetSDK.dll")]
        public static extern int NET_DVR_RealPlay_V40(int lUserID, ref NET_DVR_CLIENTINFO lpClientInfo, RealDataCallBack_V40 fRealDataCallBack_V40, int pUser, bool bBlocked);
        /// <summary>
        /// 启动客户端实时预览
        ///     NET_DVR_API LONG __stdcall NET_DVR_RealPlay(LONG lUserID,LPNET_DVR_CLIENTINFO lpClientInfo);
        /// </summary>
