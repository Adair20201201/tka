...
namespace TKA.ViewModel
{
    public class TrackViewModel : ViewModelBase
    {
        ...
        public bool LeftUpArrowAddressValue
        {
            ...
            set
            {
                if (m_LeftUpArrowAddressValue != value)
                {
                    ...
                    {
                        if (m_LeftUpArrowAddressValue == true || m_RightUpArrowAddressValue == true)
                        {
                            if (isBegin == false)
                            {
                        ...
                        {
                            timer.Stop();
                            access.InsertOperation(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), TrackNum + "道作业完成,持续时间:" + UpBreakConstant);
                            UpBreakTime = "";
                            UpBreakConstant = "";
                            isBegin = false;
                        }
            ...
            set
            {
                if (m_RightDownArrowAddressValue != value)
                {
                    ...
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    {
                        if (value)
                        {
                            RightTrackNumLightState = new SolidColorBrush(Colors.White);
                        }
                        else
                        {
        ...
        private SolidColorBrush m_LeftTrackNumLightState;
        /// <summary>
        /// 左边轨道灯的颜色
        /// </summary>
        ...
        private bool m_RightAllow = false;
        /// <summary>
        /// 允许对应
        /// </summary>
        public bool RightAllow
        {
            get { return m_RightAllow; }
            set
            {
                if (m_RightAllow != value)
                {
                    m_RightAllow = value;
                    if (value)
                    {
                    ...
                    RaisePropertyChanged(() => RightAllow);
                }
            }
        }
