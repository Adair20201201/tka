    ...
    public class VideoGroupViewModel : ViewModelBase
    {
        ...
        public void ChangeTrack(int TrackNum)
        {
            ...
            if (WestTrackVideoControl != null && WestTrackZoomVideoControl != null && EastTrackZoomVideoControl != null && EastTrackVideoControl != null)
            {
                ...
                EastTrackZoomVideoControl.ChangePlay(tc.East.Channel + dwDCStartChannelNum2);
                EastTrackVideoControl.ChangePlay(tc.East.Channel + dwDCStartChannelNum2);
        ...
        private void InfoIPChannel2()
        {
            ...
            HC_SDKFactory.DVR_NET_INIT();
            int HCUserID2 = HC_SDKFactory.Login(HCIP2, HCPort2, HCUserName2, HCPassWord2);
