...
namespace TKA.ViewModel
{
    public class TrackWarningViewModel : ViewModelBase
    {
        ...
        /// </summary>
        private static string NoteLeftUpDetaching_NotifyInfo = "道前部已上脱";
        private static string NoteRightUpDetaching_NotifyInfo = "道后部已上脱";
        private static string NoteLeftDownDetaching_NotifyInfo = "道前部已下脱";
        private static string NoteRightDownDetaching_NotifyInfo = "道后部已下脱";

        private static string NoteLeftApplyForUpDetach_NotifyInfo = "道前部申请上脱";
        private static string NoteRightApplyForUpDetach_NotifyInfo = "道后部申请上脱";
        private static string NoteLeftApplyForDownDetach_NotifyInfo = "道前部申请下脱";
        private static string NoteRightApplyForDownDetach_NotifyInfo = "道后部申请下脱";

        private static string NoteLeftCubeAddress_NotifyInfo = "道脱轨器上方异常";
        private static string NoteRightCubeAddress_NotifyInfo = "道脱轨器上方异常";
