...
namespace TKA.Business
{
    public class PLCControler
    {
        ...
        private PLCControler()
        {
            ...
            //Test.Tick += Test_Tick;
            //Test.Start();
            //MWVM.TracksVM[0].LeftUpArrowAddressValue = true;
        }
        ...
        public void InitPLC()
        {
            ...
            PLCThread.Start();
            //MWVM.WarningVM.TWVM[0].NoteFlagFault = true;
            //MWVM.WarningVM.TWVM[0].NoteLeftUpDetaching = true;
        }
        ...
        public void InitState()
        {
            ...
            GetChannelIDandPosition(out channelID, out positon, MWVM.CM.IndoorOperation);
            // get setting value for this property
            value = GetPropertyState(channelID, positon) == "1";
            // set value
            MWVM.IndoorOperation = value;
        }
        ...
        void Test_Tick(object sender, EventArgs e)
        {
            ...
            {
                int i = new Random().Next(14);

                //for (int i = 0; i < 6; i++)
                //{
                MWVM.TracksVM[i].LeftCubeAddressValue = true;
                MWVM.TracksVM[i].LeftUpArrowAddressValue = true;
                MWVM.TracksVM[i].RightCubeAddressValue = false;
                MWVM.TracksVM[i].RightUpArrowAddressValue = false;
                MWVM.TracksVM[i].LeftApplyForDownDetachAddressValue = true;

                MWVM.TracksVM[i].Allow = false;
                MWVM.TracksVM[i].Prower = false;
                MWVM.TracksVM[i].Remove = false;

                //语音
                MWVM.WarningVM.TWVM[i].NoteLeftDownDetaching = true;
                //}

                MWVM.FingerVM.ViceFingerprintCheckSuccess = true;
                MWVM.FingerVM.PremFingerprintCheckSuccess = true;
            ...
            else
            {
                ...
                //for (int i = 0; i < 6; i++)
                //{
                MWVM.TracksVM[i].LeftCubeAddressValue = false;
                MWVM.TracksVM[i].LeftUpArrowAddressValue = false;
                MWVM.TracksVM[i].RightCubeAddressValue = true;
                MWVM.TracksVM[i].RightUpArrowAddressValue = true;
                MWVM.TracksVM[i].RightApplyForUpDetachAddressValue = true;

                MWVM.TracksVM[i].Allow = true;
                MWVM.TracksVM[i].Prower = true;
                MWVM.TracksVM[i].Remove = true;

                //语音
                MWVM.WarningVM.TWVM[i].NoteLeftDownDetaching = false;
                //}

                MWVM.FingerVM.ViceFingerprintCheckSuccess = false;
                MWVM.FingerVM.PremFingerprintCheckSuccess = false;
            }
        ...
        private void ManageChannelNotificationState(TrackModel currentChannel, TrackWarningViewModel currentVM)
        {
            ...
            //GetChannelIDandPosition(out channelID, out positon, currentChannel.RightDownArrowAddress);
            //value = GetPropertyState(channelID, positon) == "1";
            //currentVM.NoteEastDownDetaching = value;
