...
namespace TKA.Model
{
    public class TrackModel
    {
        ...
        /// 轨道号标题
        /// </summary>
        public string TrackNumTitle { get; set; }
        /// <summary>
        /// 左侧铁轨方块（矩形）--表示火车是否进来
        /// </summary>
        public string LeftCubeAddress { get; set; }

        /// <summary>
        /// 右侧铁轨方块（矩形）--表示火车是否进来
        /// </summary>
        public string RightCubeAddress { get; set; }
        ...
        /// 脱轨器上方异常
        /// </summary>
        public string NoteLeftCubeAddress { get; set; }
        /// <summary>
        /// 脱轨器上方异常
        /// </summary>
        public string NoteRightCubeAddress { get; set; }
        /// <summary>
        /// 标志故障  added by 刘永强
        /// </summary>
