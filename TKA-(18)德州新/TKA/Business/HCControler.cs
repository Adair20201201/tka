    ...
    public class HC_SDK_X64 : IHCControl
    {
        ...
        public void Trun(string Direction)
        {
            ...
            if (!IsTurnStart)
            {
                ...
                HCNetSDK_X64.NET_DVR_PTZControl_Other(UserID, lpPreviewInfo.lChannel, m_direction, 0);
                IsTurnStart = !IsTurnStart;
            }
            else
            {
                HCNetSDK_X64.NET_DVR_PTZControl_Other(UserID, lpPreviewInfo.lChannel, m_direction, 1);
                IsTurnStart = !IsTurnStart;
            }
        }
