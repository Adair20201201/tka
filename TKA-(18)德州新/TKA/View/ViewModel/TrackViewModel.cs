...
namespace TKA.ViewModel
{
    public class TrackViewModel : ViewModelBase
    {
        ...
        private string m_TrackNumTitle;
        /// <summary>
        /// 铁轨号标题
        /// </summary>
        public string TrackNumTitle
        {
            get { return m_TrackNumTitle; }
            set
            {
                if (m_TrackNumTitle != value)
                {
                    m_TrackNumTitle = value;
                    RaisePropertyChanged(() => TrackNumTitle);
                }
            }
        }
            ...
            set
            {
                if (m_LeftUpArrowAddressValue != value)
                {
                    ...
                    Application.Current.Dispatcher.Invoke(new Action(() =>
                    {
                        ...
                        {
                            timer.Stop();
                            access.InsertOperation(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), TrackNumTitle + "道作业完成,持续时间:" + UpBreakConstant);
                            UpBreakTime = "";
                            UpBreakConstant = "";
                        }
                        if (value)
