...
namespace TKA.ViewModel
{
    public class VideoGroupViewModel : ViewModelBase
    {
        ...
        Dictionary<int, string> trackChannelDic = new Dictionary< int,string>();
        public VideoGroupViewModel()
        {
            trackChannelDic.Add(1,"13");
            trackChannelDic.Add(2, "12");
            trackChannelDic.Add(3, "11");
            trackChannelDic.Add(4, "10");
            trackChannelDic.Add(5, "09");
            trackChannelDic.Add(6, "08");
            trackChannelDic.Add(7, "07");
            trackChannelDic.Add(8, "06");
            trackChannelDic.Add(9, "05");
            trackChannelDic.Add(10,"04" );
            trackChannelDic.Add(11, "03");
            trackChannelDic.Add(12, "*01");
            trackChannelDic.Add(13, "*02");
            trackChannelDic.Add(14, "*03");
            trackChannelDic.Add(15, "*04");
            trackChannelDic.Add(16, "*05");
            trackChannelDic.Add(17, "*10");
            trackChannelDic.Add(18, "*11");
        }
        public void PlayAll()
        {
